...
| Delete Only    | Same as the Delete and Log option, except successful delete attempts do not write log records. This means you cannot review which records were deleted but you can review error messages for those that failed to delete. |
